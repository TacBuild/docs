...
**tvmCaller**: The TON user's wallet address in base64 mainnet bounceable format, **always starting with "EQ"**. This is your authenticated user identity - treat it like `msg.sender` in regular Ethereum contracts.
