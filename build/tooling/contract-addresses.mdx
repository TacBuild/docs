...
description: "The page lists the core TAC Protocol's contract addresses used in TON and TAC blockchains"
---
...
<Tabs>
  ...
  <Tab title="TON Testnet">
    ...
    | **NFT Proxy** | `EQBfBBdZW4mowc1TRL3gQ07fQ-T3vvqOLa7yExRZmbR75hhJ` |
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TAC Mainnet">
    ...
    | **Agnostic Proxy** | `0x1198EE17A9108733AbB085fba3AEf8E7A5f0B238` |
  ...
  <Tab title="TAC Testnet">
    ...
    | **Agnostic Proxy** | `0x4619d0Ed01a66D25F7C83E70C8515897D502cDBF` |
    | **Multicall** | `0xcA11bde05977b3631167028862bE2a173976CA11` |
