...
description: <a href='https://www.npmjs.com/package/@tonappchain/sdk'>@tonappchain/sdk</a>
---

This changelog documents all notable changes to the @tonappchain/sdk, including new features, improvements, bug fixes, and breaking changes.
