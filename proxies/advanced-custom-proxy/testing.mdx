---
title: Local Testing
description: "Testing setup for TAC proxy contracts using the `TacLocalTestSdk` library"
---
...
<Tip>
    ...
    You can also test directly in our [TON + TAC Testnet setup](/sdk/overview#testnet) using SDK.
</Tip>
