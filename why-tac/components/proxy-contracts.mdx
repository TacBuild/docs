...
<Tabs>
    <Tab title="TAC EVM Side">
        ...
        - **[Agnostic Proxy](/sdk/advanced-custom-proxy/agnostic-proxy) usage:**
...
<AccordionGroup>
    ...
    <Accordion title="Agnostic Proxy" icon="bot">
        ...
        Check out the [docs](https://github.com/TacBuild/tac-sdk/blob/main/docs/sdks/agnostic_proxy_sdk.md).
    </Accordion>
...
<Tip>Writing Custom Proxy seems tricky? Check out the [Agnostic Proxy](https://github.com/TacBuild/tac-sdk/blob/main/docs/sdks/agnostic_proxy_sdk.md) approach</Tip>
