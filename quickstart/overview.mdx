...
<Steps>
  ...
  <Step title="Start the development server" icon="play">
    ...
    <Step title="Get testnet TON" icon="coins">
        Visit the [TON Faucet bot](https://t.me/testgiver_ton_bot) and drip your coins on your TON wallet
    </Step>
...
<AccordionGroup>
  <Accordion title="Contract deployment fails" icon="triangle-alert">
    **Check your setup:**
    - Verify you have testnet TAC tokens in your deployment wallet (get them in the [Faucet](https://spb.faucet.tac.build))
